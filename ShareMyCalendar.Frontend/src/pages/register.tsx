...
import {
  ...
  useForm,
  useFetch
} from 'thomasmathers.react.hooks';
import { ApiResult, ApiValidationError, RegisterSuccessResponse } from '../responses';
...
function Register() {
  ...
  const { fetching, response, execute } = useFetch<ApiResult<ApiValidationError[], RegisterSuccessResponse>>({
